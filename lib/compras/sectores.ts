...
const REGLAS: { sector: Sector; patron: RegExp }[] = [
  ...
  { sector: "CAFETERIA", patron: /CAF[EÉ]|CABRALES|CAPUCCINO|LATTE|MOCCA|CORTADO|LAGRIMA|\bT[EÉ]\b|MATE|INFUSION|JUGO|LIMONADA|LICUADO|BEBIDA|AGUA|GASEOSA|SODA|CERVEZA|VINO|CHAMPA/i },
  ...
  { sector: "CAFETERIA", patron: /ENSALADA|LOCRO|SOPA|OMELET|HUEVOS|MILANESA|POLLO|CARNE|JAM[OÓ]N|QUESO|AVOCADO|PALTA|YOGUR|GRANOLA|CEREAL|FRUTA|TERNERA|MORTADELA|BONDIOLA|SORRENTINO|LASAGNA|LASA[NÑ]A|CERDO|RAVIOL|[NÑ]OQUI|EMPANADA|WRAP|BOWL|LECHE DE ALMENDRAS|LECHE ALMENDRAS|EXTRA HUEVO/i },
];
